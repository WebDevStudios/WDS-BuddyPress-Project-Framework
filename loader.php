...
class BP_Project_Framework {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'bp-custom-css', plugins_url( 'assets/css/bp-custom.css' , __FILE__ ), array(), filemtime( plugin_dir_path( __FILE__ ) . 'inc/bp-custom.css' ) );
		wp_enqueue_script( 'bp-custom-js', plugins_url( 'assets/js/bp-custom.js' , __FILE__ ), array(), filemtime( plugin_dir_path( __FILE__ ) . 'inc/bp-custom.js' ) );
	}
